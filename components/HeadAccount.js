...
<h1 className="font-extrabold tracking-wider text-pink">My Account Information:</h1>
...
<p className="text-green-700 font-bold tracking-wider">Wallet Address:{props.children.account}</p>
<p className="text-pink-700 font-bold tracking-wider">Balance : {props.children.balance} BNB</p>
        </div>
        </div>
        </div>
        </div>
